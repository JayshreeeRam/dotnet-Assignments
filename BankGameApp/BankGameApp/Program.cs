namespace BankGameApp
{
    internal class Program
    {
        ...
        public static void StartGame()
        {
            ...
            {
                Console.WriteLine($"Account 1 {account1.AccountHolder} won with balance: {account1.Balance:F2}");
            }
            else
            {
                Console.WriteLine($"Account 2 {account2.AccountHolder} won with balance: {account2.Balance:F2}");
            }
        }
